...
export const regions: Region[] = [
  ...
  {
    id: "yehuda-vshomron",
    nameEn: "Judea & Samaria",
    nameHe: "יהודה ושומרון",
    patterns: [
      "אריאל", "מעלה אדומים", "אפרת", "ביתר עילית", "קרית ארבע",
      "קרני שומרון", "קדומים", "עמנואל", "אלפי מנשה", "אלקנה",
      "בית אל", "עפרה", "שילה", "עלי", "אלון שבות",
      "כפר עציון", "כרמי צור", "מעלה אפרים", "כוכב יעקב",
      "גבעת זאב", "פסגות", "אדם", "נווה דניאל", "נוקדים",
      "תקוע", "אלון מורה", "יצהר", "ברקן", "רבבה",
      "חשמונאים", "מודיעין עילית", "כפר אדומים", "מצפה יריחו",
      "בית אריה", "טלמון", "עטרת", "חוות", "אזור תעשייה ברקן",
      "אזור תעשייה אריאל", "אזור תעשייה שער בנימין",
      "היישוב היהודי חברון", "הר ברכה", "הר גילה",
      "כפר תפוח", "מגדל עוז", "סוסיא", "עתניאל",
      "חיננית", "שקד", "ריחן", "מבוא דותן", "חרמש",
    ],
    bounds: { lat: [31.3, 32.55], lng: [34.95, 35.6] },
  },
];
